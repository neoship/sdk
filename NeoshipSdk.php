...
class NeoshipSdk
{
     ...
     * @param  [integer] $template PDF template for sticker.
     * @return [mixed]            returns whether write to file was succesfull
     */
    public function apiGetPackageSticker($varNums, $filename = null, $template = 0)
    {
        ...
        $result = $this->apiCall('/package/sticker', 'get', ['ref' => $varNums, 'template' => $template]);
        if ($filename) {
